				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input id="nama_barang" type="text" class="form-control" placeholder="">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label class="text-dark">Harga Beli</label>
							<input id="harga_beli" type="text" class="form-control" placeholder="">
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input id="harga_jual" type="text" class="form-control" placeholder="">
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input id="stok" type="text" class="form-control" placeholder="">
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-6">
						<div class="modal-footer">
							<a href="transaksi_batal.php" class="btn btn-light">Batal</a></button>
